...
slug: "/articles/making-the-most-of-honours-project"
draft: true
featured: true
template: "ArticleV2"
---
...
- [Coming Up With a Project Topic](#coming-up-with-a-project-topic)
  ...
  - [My Brainstorming Process ⭐](#my-brainstorming-process)
  - [How I Conceived My Eventual Final Idea ⭐](#how-i-conceived-my-eventual-final-idea)
- [Contacting Potential Supervisors](#contacting-potential-supervisors)
  - [When To Reach Out](#when-to-reach-out)
  - [Don't Be Too Specific (At First)](#dont-be-too-specific-at-first)
  - [How I Approached My Supervisor ⭐](#how-i-approached-my-supervisor)
  - [My Initial Meeting With My Supervisor ⭐](#my-initial-meeting-with-my-supervisor)
- [Creating Your Proposal](#creating-your-proposal)
  - [What To Include in Your Proposal](#what-to-include-in-your-proposal)
  - [The Proposal Length](#the-proposal-length)
  - [My Actual Proposal ⭐](#my-actual-proposal)
  - [My Project "Schedule" ⭐](#my-project-schedule)
- [Doing My Project ⭐](#doing-my-project)
  - [My Supervisor Meetings ⭐](#my-supervisor-meetings)
  - [Pivoting My Project Focus ⭐](#pivoting-my-project-focus)
...
**_What do you want to get out of doing this project?_**
...
Once you have a clear goal and some ideas in mind, visit the "Finding a Supervisor" [page](https://carleton.ca/scs/current-students/undergraduate-students/honours-project-and-directed-studies/honours-project-finding-a-supervisor/), which has a list of faculty members who are open to supervising honours projects and narrow down a few that align with your interests.
...
Here is a [link](/pdfs/articles/2026/making-the-most-of-honours-project/proposal.pdf) to the **REAL** proposal I submitted for my honours project.
...
You can find the **REAL** proof of concept implementation I created on GitHub [here](https://github.com/MathyouMB/chaos-spec-draft/blob/master/example/test/index.chaos.test.ts).

This proof of concept was a minimal implementation that demonstrated the technologies I was specifying in my proposal would actually work together as intended. In my case, that was validating that I could manage the orchestration of Docker containers and network fault injection using [Testcontainers](https://testcontainers.com/) in the Jest testing framework.
...
You can find the **REAL** repository for my honours project on GitHub [here](https://github.com/MathyouMB/chaos-spec/tree/master).
